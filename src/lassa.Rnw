...
if (!file.exists("lassa/metadata_all.tsv")) {
  ...
  for (segment in segments) {
    ...
    url <- paste0("https://data.nextstrain.org/files/workflows/lassa/", zst_file)
